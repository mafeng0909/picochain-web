          ...
          <el-container>
            ...
            <el-aside width="200px">
              <el-menu router
                ...
                @open="handleOpen"
                @close="handleClose">
                <el-menu-item index="/applicationMain">
                  <i class="el-icon-menu"></i>
                  <span slot="title" @click="flag = 1">
                    许可公链相关应用
                  </span>
                </el-menu-item>
                <el-menu-item index="/share">
                  <i class="el-icon-menu"></i>
                  <span slot="title" @click="flag = 2 ">
                    数字创意内容分享
                  </span>
                </el-menu-item>
                <el-menu-item index="/crowdsourcing">
                  <i class="el-icon-menu"></i>
                  <span slot="title" @click="flag = 3">
                    数字创意内容众包
                  </span>
                </el-menu-item>
                <el-menu-item index="/exchange">
                  <i class="el-icon-menu"></i>
                  <span slot="title" @click="flag = 4">
                    数字化货币交易所
                  </span>
                </el-menu-item>
              </el-menu>
...
export default {
  ...
  methods: {
    ...
    // },
    exchangeHandle() {
      this.$http.post("exchange/exchangeOrder", this.$qs.stringify({"order": this.order}))
        .then(resp => {
          if (resp.data) {
